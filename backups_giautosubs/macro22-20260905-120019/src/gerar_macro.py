...
def controles_topo():
    ...
    """
    return "\n".join([
        _rotulo("ApplyStyleLabel", "Actions", 3),
        _botao("ApplyStyle", "Apply Style", _APLICAR_AGORA),
        # A ordem e' de alcance crescente: este clipe, depois a timeline
        # inteira, depois o disco. O botao mais destrutivo nao pode ser o
        # primeiro que a mao encontra.
        _botao("ApplyStyleAll", "Apply Style to All Captions",
               _com_log(_APLICAR_EM_TODAS)),
...
LAYOUT = [
    ("Text", [
        ...
        "ApplyStyleLabel", "ApplyStyle", "ApplyStyleAll", "GenerateStyle",
